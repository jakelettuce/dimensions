...
### Changing Scene Background / Theme
Edit \`meta.json\` and change the \`theme\` object:
\`\`\`json
{
  "theme": {
    "background": "#0a0a0a",
...
\`\`\`
The scene background comes from \`theme.background\`. Any CSS color value works.
After saving meta.json, the scene will reload with the new theme on next load.
